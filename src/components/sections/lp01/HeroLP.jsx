                ...
                <div className="flex flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]">
                  <div className=" desktop1:mt-0">
                    <MotionDivDownToUp className="">
                      <div className="flex text-lighter justify-center desktop1:justify-start font-medium leading-[35px] phone2:leading-[40px] tablet1:leading-[65px] desktop1:leading-[70px] text-center desktop1:text-left text-title4 phone2:text-title5 phone3:text-title5 tablet1:text-title7 mb-[24px] [text-shadow:_2px_3px_0_rgb(0_0_0_/_50%)]">
                    ...
                    <MotionDivDownToUp className="">
                      <div className="flex justify-center text-center text-lighter desktop1:text-left desktop1:justify-start phone1:w-full font-secondFont text-paragraph4 phone3:text-paragraph5">
                        <p className="mb-[40px] opacity-80 [text-shadow:_2px_2px_1px_rgb(0_0_0_/_100%)]">
                ...
                <div className="flex flex-col w-full">
                  <MotionDivDownToUp className="flex justify-start tablet1:justify-center">
                    <img
                      src={contentLp01.hero.logo.logoImg}
                      alt={contentLp01.hero.logo.alt}
                      className=" max-w-[180px] phone3:max-w-[270px] tablet1:max-w-[600px] desktop1:mb-[60px]"
                    />
                  </MotionDivDownToUp>
                      ...
                      <div className="flex justify-center w-full">
                        <MotionDivDownToUp>
                          <Button
                            ...
                            buttonLink={contentLp01.links.ctaWhatsapp}
                            animation
                            className="w-[100%] text-black bg-blue-300"
                            icon={
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
